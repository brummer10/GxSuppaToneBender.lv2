...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxSuppaToneBender" ;
    ...
    set_expose_func(GX_TBENDER_PAINT_BOX(ui->pbox),"pedal_expose");
