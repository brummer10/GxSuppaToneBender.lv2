...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = { 0.5, 0.5, 0.0, 1.0, 0.01, 40, 30, 61, 61, false,"FUZZ", KNOB, FUZZ};
	ui->controls[1] = { 0.5, 0.5, 0.0, 1.0, 0.01, 120, 30, 61, 61, false,"TONE", KNOB, TONE};
	ui->controls[2] = { 0.5, 0.5, 0.0, 1.0, 0.01, 200, 30, 61, 61, false,"VOLUME", KNOB, VOLUME};
